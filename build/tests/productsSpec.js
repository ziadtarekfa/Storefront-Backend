...
describe("Test Product Endpoints", () => {
    ...
    it("gets product with id", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get('/products/3');
        expect(response.status).toBe(200);
    }));
    it("creates a product", () => __awaiter(void 0, void 0, void 0, function* () {
